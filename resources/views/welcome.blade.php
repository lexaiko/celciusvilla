...
<body>
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 sticky top-0 z-50">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Celcius</span>
            </a>
    ...
    <section class="jumbotron w-full h-screen">
            ...
            <div class="relative w-full h-full overflow-hidden">
                ...
                <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                    ...
                    <div
                        ...
                        <h1 class="text-4xl md:text-5xl font-bold mb-4">Selamat Datang di Villa Serenity</h1>
                ...
                <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                    ...
                    <div
                        class="absolute inset-0 flex flex-col justify-center items-center bg-black/50 text-white text-center p-4">
                        <h1 class="text-4xl md:text-5xl font-bold mb-4">Kolam Renang Pribadi</h1>
                        <p class="text-lg md:text-xl">Rasakan kesegaran dan privasi di kolam renang eksklusif kami.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <main class="container">
        ...
        <section class="py-16">
            ...
            <div class="flex justify-center">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-8 justify-items-center">
                    <!-- Tipe Kamar Family Room -->
                    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-xs">
                        <div class="flex items-center">
                            <img src="https://via.placeholder.com/400x300?text=Family+Room" alt="Family Room" class="mr-4 w-full h-40 object-cover rounded-lg">
                        </div>
                        <h3 class="text-xl font-semibold text-gray-700 text-left">Family Room</h3>
                        <p class="text-gray-500 mt-2 text-left">
                            Family Room dirancang untuk kenyamanan keluarga dengan ruang yang luas. Dilengkapi dengan tempat tidur nyaman dan fasilitas lengkap untuk memastikan pengalaman menginap yang menyenangkan bagi setiap anggota keluarga.
                        </p>
                    </div>
                    <!-- Tipe Kamar Dormitory Room -->
                    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-xs">
                        <div class="flex items-center">
                            <img src="https://via.placeholder.com/400x300?text=Dormitory+Room" alt="Dormitory Room" class="mr-4 w-full h-40 object-cover rounded-lg">
                        </div>
                        <h3 class="text-xl font-semibold text-gray-700 text-left">Dormitory Room</h3>
                        <p class="text-gray-500 mt-2 text-left">
                            Dormitory Room adalah pilihan sempurna untuk penginapan dalam kelompok atau backpacker. Tipe kamar ini menyediakan tempat tidur yang nyaman dengan fasilitas bersama, menjadikannya pilihan yang ideal untuk tamu yang ingin berhemat namun tetap nyaman.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container mx-auto px-6 sm:px-12 lg:px-16">
                <div class="flex flex-col lg:flex-row items-center gap-8">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <a href="#contact-us"
                            class="inline-block mt-4 bg-teal-600 text-white px-6 py-3 rounded-lg shadow hover:bg-teal-700 transition-all">
                            Hubungi Kami
                        </a>
                    </div>
                </div>
